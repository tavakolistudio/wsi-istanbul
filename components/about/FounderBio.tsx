  ...
  return (
    ...
    >
      <FadeIn className="relative aspect-[4/5] w-full overflow-hidden rounded-sm lg:w-2/5">
        <CinematicImage src={founder.image} alt={founder.name[locale]} sizes="(min-width: 1024px) 40vw, 100vw" />
      </FadeIn>
      <FadeIn delay={100} className="lg:w-3/5">
        <h3 className="font-heading text-2xl text-charcoal sm:text-3xl">{founder.name[locale]}</h3>
